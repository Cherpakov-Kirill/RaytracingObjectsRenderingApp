package nsu.graphics.fifthlab.panels.parameters;
...
public class ParametersPanel extends JPanel {
    ...
    public ParametersPanel(ParametersListener listener, int numberOfSegmentsPerInterval) {
        ...
        accept.addActionListener(e -> listener.acceptSettings(Integer.parseInt(N.getText()), Integer.parseInt(K.getText()), Integer.parseInt(m.getText()), Integer.parseInt(M.getText())));
        ...
        add(colors);
        add(buttons);
        listener.acceptSettings(Integer.parseInt(N.getText()), Integer.parseInt(K.getText()), Integer.parseInt(m.getText()), Integer.parseInt(M.getText()));
    }
